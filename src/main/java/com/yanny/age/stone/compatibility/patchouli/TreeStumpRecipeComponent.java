...
public class TreeStumpRecipeComponent extends BaseComponent {
    ...
    public void render(@Nonnull IComponentRenderContext context, float partialTicks, int mouseX, int mouseY) {
        ...
        context.renderItemStack(x + 40, y, mouseX, mouseY, BlockSubscriber.tree_stump.asItem().getDefaultInstance());
        context.renderIngredient(x + 40, y + 16, mouseX, mouseY, recipe.getTools().get(context.getTicksInBook() % recipe.getTools().size()));
