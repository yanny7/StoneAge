...
public class StonecuttinRecipeHandler implements IRecipeHandler {
    @Nonnull
    @Override
    ...
    public RecipeBackground getRecipeBackground() {
        return new RecipeBackground(new ResourceLocation(Reference.MODID, "textures/gui/manual/default_recipes.png"), 0, 183, 120,60, 256, 256);
    }
}
